          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <TextField
                ...
                error={eventData.error.title ? true : false}
                helperText={eventData.error.title}
              />
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                variant="outlined"
                style={{ width: "100%" }}
                error={eventData.error.description ? true : false}
                helperText={eventData.error.description}
              />
            </Grid>
    ...
    if (!errors) {
      ...
      try {
        let result = await fetch(
          "https://volunteernetworkbackend.herokuapp.com/api/events/add",
          {
            method: "POST",
            headers: {
